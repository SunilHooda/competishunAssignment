...
const Calorie = () => {
  ...
  const getData = async (value, cuType) => {
    let response = await axios.get(
      `https://api.edamam.com/api/recipes/v2?type=public&app_id=f98a5e33&app_key=583346362b432858e63ad8c36d50395c&cuisineType=${cuType}&calories=${value}&from=0&to=5`
    );
